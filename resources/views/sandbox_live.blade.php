@php
    ...
    if($sabreGdsInfo && $sabreGdsInfo->status == 1 && $sabreGdsInfo->is_production == 0){
    ...
    if($sabreGdsInfo && $sabreGdsInfo->status == 1 && $sabreGdsInfo->is_production == 1){
...
@php
    ...
    if($flyhubGdsInfo && $flyhubGdsInfo->status == 1 && $flyhubGdsInfo->is_production == 0){
    ...
    if($flyhubGdsInfo && $flyhubGdsInfo->status == 1 && $flyhubGdsInfo->is_production == 1){
