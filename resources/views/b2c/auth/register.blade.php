    ...
    <div class="b2c-auth-page">
        <div class="b2c-auth-card">
            <div class="b2c-auth-logo">
                ...
                <p>Join us and start booking your flights</p>
            </div>
            ...
            <form method="POST" action="{{ route('b2c.register.submit') }}">
                ...
                <div class="b2c-field-row">
                    ...
                    <div class="b2c-auth-field">
                        ...
                        <input type="text" name="phone" value="{{ old('phone') }}" placeholder="+880 1XXX XXX XXX" required>
                    </div>
                </div>
            ...
            <div class="b2c-auth-links">
                Already have an account? <a href="{{ route('b2c.login') }}">Sign In</a>
            </div>
        </div>
    </div>
@endsection