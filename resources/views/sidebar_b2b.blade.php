    ...
    <div class="sidebar-body">
        ...
        <nav class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="@if($currentRoute == 'view/saved/passengers') mm-active @endif">
                ...
                <li
                    class="@if(in_array($currentRoute, ['ViewBankAccounts', 'AddBankAccount', 'EditBankAccount', 'ViewMfsAccounts', 'AddMfsAccount', 'EditMfsAccount', 'CreateTopupRequest', 'ViewRechargeRequests'])) mm-active @endif">
                    <a class="has-arrow material-ripple" href="javascript:void(0);">
