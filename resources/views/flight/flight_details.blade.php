                            ...
                            <div class="align-items-center d-flex custom-gap justify-content-between w-100">
                                ...
                                <div class="text-center fs-14 w-100">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <span class="d-inline-flex align-items-center w-max-content">
                                            @php
                                                $passengerWisebaggage = $data['pricingInformation'][0]['fare']['passengerInfoList'];

                                                foreach ($passengerWisebaggage as $passengerWisebaggageInfo) {
                                                    if (isset($passengerWisebaggageInfo['passengerInfo']['baggageInformation'][0]['allowance']['ref'])) {

                                                        $baggageRef = $passengerWisebaggageInfo['passengerInfo']['baggageInformation'][0]['allowance']['ref'];
                                                        if (isset($searchResults['groupedItineraryResponse']['baggageAllowanceDescs'][$baggageRef - 1])) {
                                                            echo $passengerWisebaggageInfo['passengerInfo']['passengerType'] . '(' . $passengerWisebaggageInfo['passengerInfo']['passengerNumber'] . '): ';

                                                            if (isset($searchResults['groupedItineraryResponse']['baggageAllowanceDescs'][$baggageRef - 1]['pieceCount'])) {
                                                                echo 'Piece Count: ' . $searchResults['groupedItineraryResponse']['baggageAllowanceDescs'][$baggageRef - 1]['pieceCount'] * $passengerWisebaggageInfo['passengerInfo']['passengerNumber'];
                                                            }
                                                            if (isset($searchResults['groupedItineraryResponse']['baggageAllowanceDescs'][$baggageRef - 1]['weight'])) {
                                                                echo $searchResults['groupedItineraryResponse']['baggageAllowanceDescs'][$baggageRef - 1]['weight'] * $passengerWisebaggageInfo['passengerInfo']['passengerNumber'];
                                                            }
