...
<div class="col-lg-2 flight_timing">
    <h6 class="mb-1">{{(new DateTimeImmutable($segmentArray[0]['departure']['dateTime']))->format("jS M, y")}}</h6>
...
<div class="col-lg-2 flight_timing">
    <h6 class="mb-1">{{ (new DateTimeImmutable(end($segmentArray)['arrival']['dateTime']))->format("jS M, y") }}</h6>
