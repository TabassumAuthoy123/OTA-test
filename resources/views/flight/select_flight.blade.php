                                                            ...
                                                            <div class="d-flex align-items-center justify-content-center">
                                                                <span
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        foreach (
                                                                            $passengerWisebaggage
                                                                            as $passengerWisebaggageInfo
                                                                        ) {
                                                                            if (
                                                                                isset(
                                                                                    $passengerWisebaggageInfo[
                                                                                        'passengerInfo'
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-12 col-md-8 mb-2 mb-sm-3" style="position: relative">
                                    <input name="traveller_contact" id="search_keyword" onkeyup="liveSearchpassenger()" autocomplete="off" type="text" class="form-control" placeholder="+8801*********" required="">
                            ...
                            @foreach ($revlidatedData['groupedItineraryResponse']['itineraryGroups'][0]['itineraries'][0]['pricingInformation'][0]['fare']['passengerInfoList'] as $passengerInfoList)
                                @for ($i = 1; $i <= $passengerInfoList['passengerInfo']['passengerNumber']; $i++)
                                    ...
                                    <div class="form-row mt-3">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <div class="input-select position-relative">
                                                <select id="select_passenger_{{$passengerTitleIndex}}" class="mySelect2" onchange="fillUpCustomerDetails(this, {{$passengerTitleIndex}})">
                                                    <option value="">Select Customer</option>
                                                    @foreach($savedpassengers as $savedpassenger)
                                                    <option

                                                        value="{{$savedpassenger->id}}"
                                                        data_title="{{$savedpassenger->title}}"
                                                        ...
                                                        data_dob="{{$savedpassenger->dob}}"
                                                        data_age="{{$savedpassenger->age}}"
                                                    ...
                                                    >{{$savedpassenger->title}} {{$savedpassenger->first_name}} {{$savedpassenger->last_name}} ({{$savedpassenger->dob}})</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <input type="hidden" name="passenger_type[]" value="{{ $passengerInfoList['passengerInfo']['passengerType'] }}">
                                    <div class="form-row mt-3">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="titles[{{ $passengerTitleIndex }}]" id="passenger_title_{{ $passengerTitleIndex }}_mr" value="Mr.">
                                                <label class="form-check-label" for="passenger_title_{{ $passengerTitleIndex }}_mr">Mr.</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="titles[{{ $passengerTitleIndex }}]" id="passenger_title_{{ $passengerTitleIndex }}_mrs" value="Mrs.">
                                                <label class="form-check-label" for="passenger_title_{{ $passengerTitleIndex }}_mrs">Mrs.</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="titles[{{ $passengerTitleIndex }}]" id="passenger_title_{{ $passengerTitleIndex }}_ms" value="Ms.">
                                                <label class="form-check-label" for="passenger_title_{{ $passengerTitleIndex }}_ms">Ms.</label>
                                            </div>
                                        </div>
                                        @else
                                        <div class="col-sm-6 col-md-6">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="titles[{{ $passengerTitleIndex }}]" id="passenger_title_{{ $passengerTitleIndex }}_mstr" value="Mstr.">
                                                <label class="form-check-label" for="passenger_title_{{ $passengerTitleIndex }}_mstr">Mstr.</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="titles[{{ $passengerTitleIndex }}]" id="passenger_title_{{ $passengerTitleIndex }}_miss" value="Miss.">
                                                <label class="form-check-label" for="passenger_title_{{ $passengerTitleIndex }}_miss">Miss.</label>
                                            </div>
                                        </div>
                                        @endif
                                    ...
                                    <div class="form-row mt-3">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <div class="input-select position-relative">
                                                        <input name="first_name[]" id="first_name_{{$passengerTitleIndex}}" type="text" class="form-control" placeholder="First name" required="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <input name="last_name[]" id="last_name_{{$passengerTitleIndex}}" type="text" class="form-control" placeholder="Last name" required="">
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <div class="input-select position-relative">
                                                        <input name="email[]" id="email_{{$passengerTitleIndex}}" type="text" class="form-control" placeholder="example@email.com">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <input name="phone[]" id="phone_{{$passengerTitleIndex}}" type="text" class="form-control" placeholder="Phone No.">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <div class="row g-3">
                                                <div class="col">
                                                    <input required="" id="dob_{{$passengerTitleIndex}}" class="form-control" type="date"
                                                ...
                                                @if($passengerInfoList['passengerInfo']['passengerType'] != 'ADT')
                                                <div class="col">
                                                    <input id="age_{{$passengerTitleIndex}}" class="form-control" type="number" name="age[]" required=""
                                                ...
                                                @else
                                                    <input id="age_{{$passengerTitleIndex}}" class="form-control" type="hidden" value="18" name="age[]">
                                                @endif
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <select name="document_type[]" id="document_type_{{$passengerTitleIndex}}" class="form-select" required>
                                                        <option value="1" selected="">Passport</option>
                                                        <option value="2">National id</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-6">
                                                    <input name="document_no[]" id="document_no_{{$passengerTitleIndex}}" type="text" class="form-control"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <input required="" id="document_expire_date_{{$passengerTitleIndex}}" name="document_expire_date[]" type="date"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-6">
                                                    <select id="document_issue_country_{{$passengerTitleIndex}}" required="" name="document_issue_country[]" class="form-select" aria-label="Default select example">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <select id="nationality_{{$passengerTitleIndex}}" required="" name="nationality[]" class="form-select"
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="frequent_flyer_no_{{$passengerTitleIndex}}" name="frequent_flyer_no[]" class="form-control"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-12 col-md-8 mb-3 mb-sm-3">
                                            <label class="d-block mt-2">
                                                <input type="checkbox" name="save_passenger[]" value="{{ $passengerTitleIndex }}"> Save Passenger Information
                                            </label>
                                        </div>
                                    </div>
