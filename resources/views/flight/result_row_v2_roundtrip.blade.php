    ...
    <div class="col-lg-10">
        <div class="row">
            ...
            <div class="col-lg-2 flight_timing">
                <h6 class="mb-1">{{(new DateTimeImmutable($onewaySegmentArray[0]['departure']['dateTime']))->format("jS M, y")}}</h6>
            ...
            <div class="col-lg-2 flight_timing">
                <h6 class="mb-1">{{ (new DateTimeImmutable(end($onewaySegmentArray)['arrival']['dateTime']))->format("jS M, y") }}</h6>
        ...
        <div class="row mt-3 pt-3 border-top">
            ...
            <div class="col-lg-2 flight_timing">
                <h6 class="mb-1">{{(new DateTimeImmutable($roundTripSegmentArray[0]['departure']['dateTime']))->format("jS M, y")}}</h6>
            ...
            <div class="col-lg-2 flight_timing">
                <h6 class="mb-1">{{(new DateTimeImmutable(end($roundTripSegmentArray)['arrival']['dateTime']))->format("jS M, y")}}</h6>
