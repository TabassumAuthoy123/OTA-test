...
<div class="row"><div class="col-lg-12">
  <div class="card" style="border-radius:8px;overflow:hidden;">
    <div class="b2c-page-header">
      <div>
        <h5>Upcoming B2C Flight Booking List</h5>
        <small>Dashboard &rsaquo; B2c &rsaquo; Upcoming-bookings</small>
      </div>
      <a href="{{ url('b2c/upcoming-flights') }}?{{ http_build_query(array_merge(request()->all(),['export'=>'excel'])) }}" class="btn-excel">
        Export to Excel
      </a>
    </div>
    <form method="GET" action="{{ url('b2c/upcoming-flights') }}">
      <div class="b2c-filters">
        ...
        <div class="filter-group">
          <label>&nbsp;</label>
          <button type="submit" class="btn btn-primary btn-sm" style="height:34px;"><i class="fas fa-search"></i></button>
        </div>
      </div>
    </form>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                @else<span class="s-2">Issued</span>@endif
              </td>
            ...
            <tr>
              <td colspan="12" class="text-center py-5 text-muted">
                <i class="fas fa-plane-departure fa-2x mb-2 d-block" style="opacity:.3;"></i>
                No data
              </td>
            </tr>
            @endforelse
