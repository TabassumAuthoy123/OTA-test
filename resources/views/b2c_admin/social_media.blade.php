...
<div class="row"><div class="col-lg-12">
  ...
  <div class="card" style="border-radius:8px;overflow:hidden;">
    <div class="b2c-page-header">
      ...
      <button class="btn-add" data-bs-toggle="modal" data-bs-target="#addModal">+ Add Social Media</button>
    </div>
      ...
      <div class="table-responsive">
        <table class="table table-bordered mb-0 b2c-table">
          ...
          <tbody>
            ...
            @empty
            <tr><td colspan="6" class="text-center py-5 text-muted">No social media links.</td></tr>
            @endforelse
          </tbody>
        </table>
      </div>
