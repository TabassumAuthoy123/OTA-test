...
<body>
    ...
    <table class="booking_info" border="0">
        ...
        <tr>
            ...
            <td>
                @if($flightpassengers[0]->ticket_no == null && $flightBookingDetails->last_ticket_datetime)
    ...
    <table border="0" style="width: 100%; padding: 0; margin: 0; margin-top: 15px; border-collapse: collapse; ">
        <tr>
            <th colspan="5" style="text-align: center; font-size: 14px; background-color: lightgreen; padding: 4px 0px;">Flight passengers</th>
        </tr>
        <tr>
        ...
        @foreach ($flightpassengers as $flightpassenger)
        <tr>
            <td style="text-align: center; font-size: 12px; padding: 2px 4px;">@if($flightpassenger->ticket_no){{$flightpassenger->ticket_no}}@else N/A @endif</td>
            <td style="text-align: center; font-size: 12px; padding: 2px 4px;">{{$flightpassenger->passenger_type}}</td>
            <td style="text-align: left; font-size: 12px; padding: 2px 4px;">{{$flightpassenger->title}} {{$flightpassenger->first_name}} {{$flightpassenger->last_name}}</td>
            <td style="text-align: center; font-size: 12px; padding: 2px 4px;">{{$flightpassenger->document_no}}</td>
            <td style="text-align: center; font-size: 12px; padding: 2px 4px;">{{$flightpassenger->dob}}</td>
        </tr>
        @endforeach
    </table>
