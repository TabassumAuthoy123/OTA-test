                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-2 border-end">
                            ...
                            <table>
                                <tr>
                                    <th>Source </th>
                                    <td>: @if($flightBookingDetails->source == 1) OTA Portal @elseif($flightBookingDetails->source == 2) Website @else Mobile App @endif</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    @endphp
                                    <td>: {{ $bookedByUser ? $bookedByUser->name : 'passenger' }}</td>
                                </tr>
                            ...
                            <table class="table table-bordered border-dark table-sm table-striped table-hover">
                                <thead>
                                    <tr class="table-success">
                                        <th scope="col" class="text-center" colspan="10" style="font-size: 14px">Flight passengers</th>
                                    </tr>
                                    <tr class="table-success">
                                ...
                                <tbody>
                                    @foreach ($flightpassengers as $passengerIndex => $flightpassenger)
                                        <tr>
                                            <th scope="row">{{ $passengerIndex + 1 }}</th>
                                            <td class="text-center">@if($flightpassenger->ticket_no){{ $flightpassenger->ticket_no }}@else N/A @endif</td>
                                            <td class="text-center">{{ $flightpassenger->passenger_type }}</td>
                                            <td class="text-center">{{ $flightpassenger->title }} {{ $flightpassenger->first_name }} {{ $flightpassenger->last_name }}</td>
                                            <td class="text-center">{{ $flightpassenger->dob }}</td>
                                            ...
                                            <td class="text-center">{{ $flightpassenger->document_no }}</td>
                                            <td class="text-center">{{ $flightpassenger->document_expire_date }}</td>
                                            <td class="text-center">{{ $flightpassenger->document_issue_country }}</td>
                                            <td class="text-center">{{ $flightpassenger->nationality }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
