                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <label id="customFilter">
                                <a href="<?php echo e(url('add/new/banner')); ?>" style="margin-left: 5px" class="btn btn-success btn-sm"><b><i class="fas fa-plus"></i> Add New Banner</b></a>
                            </label>
...
<?php $__env->startSection('footer_js'); ?>
    ...
    <script type="text/javascript">
        var table = $(".data-table").DataTable({
            ...
            ajax: "<?php echo e(url('view/all/banners')); ?>",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: '',
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function () {
            ...
            if(confirm("Are You sure want to delete !")){
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('delete/banner')); ?>"+'/'+slug,
        ...
        $('body').on('click', '.approveBtn', function () {
            ...
            if(confirm("Are You sure want to Approve !")){
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('approve/recharge/request')); ?>"+'/'+slug,
                    success: function (data) {
                        table.draw(false);
        ...
        $('body').on('click', '.denyBtn', function () {
            ...
            if(confirm("Are You sure want to Deny !")){
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('deny/recharge/request')); ?>"+'/'+slug,
                    success: function (data) {
                        table.draw(false);
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Softifybd Devs\OTA-Platform\resources\views/banners/view.blade.php ENDPATH**/ ?>