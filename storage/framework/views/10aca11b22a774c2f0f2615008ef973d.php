...
<?php $__env->startSection('title', 'Book Flights at Best Price'); ?>
<?php $__env->startSection('meta_description', 'Book domestic and international flights at the best price. Instant confirmation, secure payment, 24/7 support.'); ?>
...
<?php $__env->startSection('styles'); ?>
    ...
    <link href="<?php echo e(url('assets')); ?>/nanopkg-assets/vendor/t-datepicker-master/public/theme/css/t-datepicker.min.css"
        rel="stylesheet" />
    <link href="<?php echo e(url('assets')); ?>/nanopkg-assets/vendor/t-datepicker-master/public/theme/css/themes/t-datepicker-main.css"
        rel="stylesheet" />
        ...
        <div class="container">
            <div class="b2c-hero-content">
                ...
                <div class="b2c-hero-badge">
                    ...
                    <?php echo e($siteSettings['hero_badge'] ?? 'Trusted by 10,000+ travelers'); ?>

                </div>

                
                <h1 class="b2c-hero-title">
                    <?php echo $siteSettings['hero_title'] ?? 'Find & Book <span>Best Flights</span><br>At Unbeatable Prices'; ?>
                    ...
                    <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="b2c-deal-card">
                            <div class="b2c-deal-image"
                                style="background: <?php echo e($promo->badge_color ?? 'var(--b2c-gradient-accent)'); ?>">
                                <?php if($promo->image): ?>
                                    <img src="<?php echo e($promo->image); ?>" alt="<?php echo e($promo->title); ?>">
                                <?php else: ?>
                                    <i class="fas fa-percentage" style="font-size: 3rem; color: rgba(255,255,255,0.3);"></i>
                                <?php endif; ?>
                                <?php if($promo->discount_text): ?>
                                    <span class="b2c-deal-badge" style="background: <?php echo e($promo->badge_color ?? '#dc3545'); ?>">
                                        <?php echo e($promo->discount_text); ?>

                                    </span>
                                <?php endif; ?>
                            </div>
                            <div class="b2c-deal-body">
                                <div class="b2c-deal-title"><?php echo e($promo->title); ?></div>
                                <div class="b2c-deal-desc"><?php echo e(Str::limit($promo->description, 80)); ?></div>
                                <?php if($promo->link): ?>
                                    <a href="<?php echo e($promo->link); ?>" class="b2c-deal-link">
            ...
            <div class="container">
                ...
                <div class="b2c-routes-grid">
                    <?php $__currentLoopData = $popularRoutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(url('/flights/search?origin=' . $route->origin_code . '&destination=' . $route->destination_code)); ?>"
                            class="b2c-route-card">
                            <div class="b2c-route-icon">
                                <?php if($route->image): ?>
                                    <img src="<?php echo e($route->image); ?>" alt="<?php echo e($route->destination_city); ?>">
                                <?php else: ?>
                                    <i class="fas fa-plane"></i>
                                <?php endif; ?>
                            </div>
                            <div class="b2c-route-name"><?php echo e($route->origin_city); ?> → <?php echo e($route->destination_city); ?></div>
                            <div class="b2c-route-code"><?php echo e($route->origin_code); ?> → <?php echo e($route->destination_code); ?></div>
                            <div class="b2c-route-price">
                                ৳<?php echo e(number_format($route->starting_price)); ?>
                ...
                <div class="b2c-testimonials-grid">
                    <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="b2c-testimonial-card">
                            ...
                            <p class="b2c-testimonial-text">"<?php echo e($testimonial->review); ?>"</p>
                            <div class="b2c-testimonial-author">
                                <div class="b2c-testimonial-avatar">
                                    <?php if($testimonial->customer_photo): ?>
                                        <img src="<?php echo e($testimonial->customer_photo); ?>" alt="<?php echo e($testimonial->customer_name); ?>"
                                ...
                                <span class="b2c-testimonial-name"><?php echo e($testimonial->customer_name); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script
        src="<?php echo e(url('assets')); ?>/nanopkg-assets/vendor/t-datepicker-master/public/theme/js/t-datepicker.min.js"></script>
    ...
    <script>
        ...
        function searchForFlights() {
            ...
            $.ajax({
                data: formData,
                url: "<?php echo e(url('/flights/search')); ?>",
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
        ...
        function searchMultiCityFlights() {
            ...
            $.ajax({
                data: formData,
                url: "<?php echo e(url('/flights/search/multi-city')); ?>",
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('b2c.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Softifybd Devs\OTA-Platform\resources\views/b2c/home.blade.php ENDPATH**/ ?>