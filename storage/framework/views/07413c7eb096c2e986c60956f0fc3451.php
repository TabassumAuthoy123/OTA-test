...
<head>
    ...
    <meta name="description" content="<?php echo e(env('APP_NAME')); ?> is an OTA" />
    <meta name="robots" content="all" />
    <meta property="og:title" content="<?php echo e(env('APP_NAME')); ?>" />
    <meta property="og:description" content="<?php echo e(env('APP_NAME')); ?> is an OTA" />
    <meta property="og:url" content="<?php echo e(env('APP_NAME')); ?> is an OTA" />
    ...
    <link href="<?php echo e(url('assets')); ?>/admin-assets/vendor/metisMenu/metisMenu.min.css" rel="stylesheet" />
    <link href="<?php echo e(url('assets')); ?>/admin-assets/vendor/daterangepicker/daterangepicker.css" rel="stylesheet" />
...
<body data-departure="Departure" data-return="Return" class="fixed sidebar-mini" data-app-config>
    ...
    <div x-data="{ m: false }">
        <div class="wrapper">
            ...
            <?php else: ?>
                <?php echo $__env->make('sidebar_b2b', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
    ...
    <script src="<?php echo e(url('assets')); ?>/admin-assets/vendor/select2/dist/js/select2.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/vendor/t-datepicker-master/public/theme/js/t-datepicker.min.js">
    </script>
    <script src="<?php echo e(url('assets')); ?>/admin-assets/vendor/metisMenu/metisMenu.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/admin-assets/vendor/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/vendor/sweetalert2/sweetalert2.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/vendor/fontawesome-free-6.3.0-web/js/all.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/vendor/toastr/build/toastr.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/vendor/axios/dist/axios.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/js/axios.init.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/js/arrow-hidden.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/js/img-src.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/js/delete.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/js/user-status-update.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/admin-assets/vendor/moment/moment.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/admin-assets/vendor/daterangepicker/daterangepicker.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/admin-assets/js/ajax_form_submission.min.js"></script>
    
    <script src="<?php echo e(url('assets')); ?>/module-assets/js/booking/booking.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/module-assets/js/setting/setting.min.js"></script>
    <script src="<?php echo e(url('assets')); ?>/nanopkg-assets/js/main.min.js"></script>
