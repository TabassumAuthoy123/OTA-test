<?php $__env->startSection('header_css'); ?>
    ...
    <link href="<?php echo e(url('assets')); ?>/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.css" rel="stylesheet" type="text/css" />
    <style>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="<?php echo e(url('submit/recharge/request')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card">
                                    ...
                                    <div class="co-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select id="user_id" name="user_id" class="form-select">
                                                ...
                                                <?php $__currentLoopData = $b2bUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b2bUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($b2bUser->id); ?>"><?php echo e($b2bUser->name); ?> - <?php echo e($b2bUser->email); ?></option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="admin_bank_account_id" id="admin_bank_account_id">
                                                ...
                                                <option value="<?php echo e($bankAccount->id); ?>"><?php echo e($bankAccount->acc_no); ?> - <?php echo e($bankAccount->bank_name); ?> (<?php echo e($bankAccount->branch_name."-".$bankAccount->routing_no); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="admin_mfs_account_id" id="admin_mfs_account_id">
                                                <option value="">Select One</option>
                                                <?php $__currentLoopData = $mfsAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mfsAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        $mfsAccountType = '';
                                                    ...
                                                    ?>
                                                    <option value="<?php echo e($mfsAccount->id); ?>" class="<?php echo e($mfsAccountType); ?>"><?php echo e($mfsAccount->acc_no); ?> (<?php echo e($mfsAccountType); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row pt-3">
                                    ...
                                    <div class="col" id="transaction_id">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="tran_id" value="<?php echo e(old('transaction_id')); ?>" placeholder="Transaction ID" name="transaction_id" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Softifybd Devs\OTA-Platform\resources\views/recharge/create.blade.php ENDPATH**/ ?>