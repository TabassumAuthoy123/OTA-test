...
<?php $__env->startSection('footer_js'); ?>
    ...
    <script type="text/javascript">
        var table = $(".data-table").DataTable({
            ...
            ajax: "<?php echo e(url('view/recharge/requests')); ?>",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: '',
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function () {
            ...
            if(confirm("Are You sure want to delete !")){
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('delete/recharge/request')); ?>"+'/'+slug,
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Softifybd Devs\OTA-Platform\resources\views/recharge/view.blade.php ENDPATH**/ ?>