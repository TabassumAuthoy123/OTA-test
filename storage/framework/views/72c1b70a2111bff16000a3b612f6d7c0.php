                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <label id="customFilter">
                                <a href="<?php echo e(url('add/bank/account')); ?>" style="margin-left: 5px" class="btn btn-success btn-sm"><b><i class="fas fa-plus"></i> Add Bank Account</b></a>
                            </label>
...
<?php $__env->startSection('footer_js'); ?>
    ...
    <script type="text/javascript">
        var table = $(".data-table").DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(url('view/bank/accounts')); ?>",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function () {
            ...
            if(confirm("Are You sure want to delete !")){
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('delete/bank/account')); ?>"+'/'+slug,
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Softifybd Devs\OTA-Platform\resources\views/bank_accounts/view.blade.php ENDPATH**/ ?>