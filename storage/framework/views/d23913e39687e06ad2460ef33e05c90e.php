...
<?php $__env->startSection('footer_js'); ?>
    ...
    <script type="text/javascript">
        var table = $(".data-table").DataTable({
            ...
            ajax: "<?php echo e(url('view/issued/tickets')); ?>",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: '',
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Softifybd Devs\OTA-Platform\resources\views/booking/issued_ticket.blade.php ENDPATH**/ ?>