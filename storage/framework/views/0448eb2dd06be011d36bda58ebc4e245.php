...
<?php $__env->startSection('footer_js'); ?>
    ...
    <script type="text/javascript">
        var table = $(".data-table").DataTable({
            ...
            ajax: "<?php echo e(url('view/office/address')); ?>",
            columns: [{
                    data: 'DT_RowIndex',
                    name: '',
                    orderable: false,
        ...
        $('#saveBtn').click(function (e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('save/office/address')); ?>",
                type: "POST",
                dataType: 'json',
        ...
        $('body').on('click', '.deleteBtn', function () {
            ...
            if(confirm("Are You sure want to delete !")){
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(url('delete/office/address')); ?>"+'/'+slug,
                    success: function (data) {
                        table.draw(false);
        ...
        $('body').on('click', '.editBtn', function () {
            ...
            $.get("<?php echo e(url('get/office/address')); ?>" + '/' + slug, function (data) {
                // Set values
        ...
        $('#updateBtn').click(function (e) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('update/office/address')); ?>",
                type: "POST",
                dataType: 'json',
                success: function (data) {
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\Softifybd Devs\OTA-Platform\resources\views/office_address.blade.php ENDPATH**/ ?>