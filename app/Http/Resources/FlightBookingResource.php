...
class FlightBookingResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'payment_status' => PaymentStatus::tryFrom($this->payment_status)?->label() ?? 'Unknown',
            ...
            'passengers' => FlightPassangerResource::collection(FlightPassenger::where('flight_booking_id', $this->id)->get()),
        ];
    }
}
