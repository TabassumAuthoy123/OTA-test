...
use App\Http\Requests\UpdateGdsStatusRequest;
use App\Http\Requests\UpdateSabreGdsRequest;
use App\Http\Requests\UpdateFlyhubGdsRequest;
use App\Http\Requests\SaveExcludedAirlineRequest;
use App\Http\Requests\UpdateAirlineCommissionRequest;
...
class GdsController extends Controller
{
    ...
    public function updateSabreGdsInfo(UpdateSabreGdsRequest $request)
    {
    ...
    public function updateFlyhubGdsInfo(UpdateFlyhubGdsRequest $request)
    {
    ...
    public function saveExcludedAirline(SaveExcludedAirlineRequest $request)
    {
    ...
    public function updateAirlineComission(UpdateAirlineCommissionRequest $request)
    {
