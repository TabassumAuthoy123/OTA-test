...
use App\Http\Requests\SaveOfficeAddressRequest;
use App\Http\Requests\UpdateOfficeAddressRequest;
...
class OfficeAddressController extends Controller
{
    ...
    public function saveOfficeAddress(SaveOfficeAddressRequest $request)
    {
    ...
    public function updateOfficeAddress(UpdateOfficeAddressRequest $request)
    {
