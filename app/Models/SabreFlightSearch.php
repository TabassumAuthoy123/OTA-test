...
class SabreFlightSearch extends Model
{
    ...
    public static function checkForAccessToken(){
    ...
    public static function getFlightSearchResults($originCityCode, $destinationCityCode, $departureDate, $returnDate, $adult, $child, $infant, $flightType, $cabinClass, $airlinePrefs){
        ...
        SabreFlightSearch::checkForAccessToken();
    ...
    public static function getMultiCitySearchResults($segmentsArray, $adult, $child, $infant, $cabinClass, $airlinePrefs){
        ...
        // oneway or return flights
        $flightTypeData = array();
        foreach ($segmentsArray as $i => $seg) {
            $flightTypeData[] = array_filter([
                "RPH" => (string)($i + 1),
                "DepartureDateTime" => $seg['departure_date'] . "T00:00:00",
                "OriginLocation" => ["LocationCode" => $seg['origin_airport_code']],
                "DestinationLocation" => ["LocationCode" => $seg['destination_airport_code']],
                "TPA_Extensions" => !empty($tpaExtensions) ? $tpaExtensions : null
            ], fn($v) => $v !== null);
        }
